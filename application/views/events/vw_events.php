    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-lg-10 grid-margin stretch-card">
        ...
        <i class="fas fa-table me-1"></i>
           <a href="<?= base_url('events/tambah_events');?>" class="btn btn-primary" style="float: right;"> + tambah </a>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php
                        ...
                        <tr>
                          ...
                          <td><?= $row->organizer ?></td>
                          <td>
                            <a href="<?= base_url('events/edit_events/' . $row->event_id);?>" class="btn btn-primary round btn-sm">edit<i data-feather="edit"></i></a>
                            <a href="<?= base_url('events/hapus_events/' . $row->event_id); ?>" class="btn btn-danger round btn-sm">hapus<i data-feather="trash"></i></a>
                            </td>
                        </tr>
                        <?php
                      }

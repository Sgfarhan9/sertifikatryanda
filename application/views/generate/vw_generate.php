    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-lg-10 grid-margin stretch-card">
        ...
        <i class="fas fa-table me-1"></i>
           <a href="<?= base_url('generate/tambah_generate');?>" class="btn btn-primary" style="float: right;"> + tambah </a>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                      ...
                      <?php
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="<?= base_url('generate/download/' . $row->assignment_id);?>" class="btn btn-primary round btn-sm">download<i data-feather="download"></i></a>
                            <a href="<?= base_url('generate/hapus_generate/' . $row->assignment_id); ?>" class="btn btn-danger round btn-sm">hapus<i data-feather="trash"></i></a>
                            </td>
                        </tr>
                        <?php
                      }
